...
acc_x_multiplier = (2 * g) / acc_x_range
acc_y_multiplier = (2 * g) / acc_y_range
acc_z_multiplier = (2 * g) / acc_z_range 

acc_x_offset = 0 #g - (acc_x_p * acc_x_multiplier)
acc_y_offset = 0 #g - (acc_y_p * acc_y_multiplier)
acc_z_offset = 0 #g - (acc_z_p * acc_z_multiplier)
